...
public class IntroLab {
    ...
    /**
     * A method that calls on printLabMessage to greet the student Charlie Morocz
     */
    public static String moroczch() {
        return printLabMessage("Hello", "Charlie", false, "You got this!");
